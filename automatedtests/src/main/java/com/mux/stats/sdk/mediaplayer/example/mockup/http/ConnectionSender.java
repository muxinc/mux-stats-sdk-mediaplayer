...
public class ConnectionSender extends Thread {
  ...
  public ConnectionSender(Context context, ConnectionListener listener, OutputStream httpOut, int bandwidthLimit,
  ...
  private void openAssetFile(String assetFile) throws IOException {
    ...
    try {
      AssetFileDescriptor fd = context.getAssets().openFd(assetFile);
    ...
    assetInput = context.getAssets().open(assetFile);
