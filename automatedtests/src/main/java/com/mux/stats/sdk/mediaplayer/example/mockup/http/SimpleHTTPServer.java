...
public class SimpleHTTPServer extends Thread implements ConnectionListener {
   ...
   */
  public SimpleHTTPServer(Context context, int port, int bandwidthLimit) throws IOException {
...
//                // Ignore, sombody killed the server
  ...
  private void acceptConnection() throws IOException {
    ...
    workers.add(new ConnectionWorker(context,this, clientSocket, bandwidthLimit,
